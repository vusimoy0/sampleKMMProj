package za.co.kernelpanic.food2forkkmm.android.presentation.recipelist.components
    ...
    Surface(
        ...
        Column {
            Row(modifier = Modifier.fillMaxWidth()) {
                TextField(
                    ...
                    leadingIcon = {
                        Icon(
                            Icons.Filled.Search,
                            contentDescription = "recipeSearch"
                        )
                    },
            ...
            LazyRow(modifier = Modifier.padding(start = 8.dp, bottom = 8.dp)) {
                items(categories) {
                    FoodCategoryChip(category = it.value, isSelected = selectedCategory == it,
